...
INSERT INTO item_category(item_id, category_id) VALUES(64, 100015) ON CONFLICT DO NOTHING;

INSERT INTO item(id, name) VALUES(65, 'item_dvd') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name;
INSERT INTO item_category(item_id, category_id) VALUES(65, 100015) ON CONFLICT DO NOTHING;
...
INSERT INTO item_category(item_id, category_id) VALUES(392, 6) ON CONFLICT DO NOTHING;

INSERT INTO item(id, name) VALUES(393, 'item_rope'); -- Rope = Seil
INSERT INTO item_category(item_id, category_id) VALUES(393, 6) ON CONFLICT DO NOTHING;

INSERT INTO item(id, name) VALUES(394, 'item_earrings'); -- Earring (metal) = Ohrring (Metall)
INSERT INTO item_category(item_id, category_id) VALUES(394, 6) ON CONFLICT DO NOTHING;
